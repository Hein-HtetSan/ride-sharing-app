...
public class RMIServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("UserService is available at: rmi://localhost:1099/UserService");
            System.out.println("LocationService is available at: rmi://localhost:1099/LocationService");
